...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2023 06:36:15 GMT -->
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{asset('assets/images/Smart Enghlish Logo.png')}}" alt="" height="60" style="margin-top: 15px;">
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('dashboard')}}">
                                <i class="ri-dashboard-2-line text-dark"></i>
                                <span class="text-dark">Dashboard</span></a>
                        </li> <!-- end Dashboard Menu -->
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('Add Case-list')}}">
                                <i class="fa fa-sliders text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Add Cash</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('banner_list')}}">
                                <i class="fa fa-angellist  text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Banner</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('course_list')}}">
                                <i class="fa fa-book text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Course</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('testimonial_list')}}">
                                <i class="fa fa-bolt  text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Testimonial</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('form_list')}}">
                                <i class="fa fa-plus-square-o text-dark" aria-hidden="true "></i>
                                <span class="text-dark">form</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('eduction_list')}}">
                                <i class="fa fa-plus-square-o text-dark" aria-hidden="true "></i>
                                <span class="text-dark">Eduction Form</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('gallery_list')}}">
                                <i class="fa fa-picture-o text-dark " aria-hidden="true"></i>
                                <span class="text-dark">Gallery</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('personality_list')}}">
                                <i class="fa fa-step-forward text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Personality Development</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{url('batch_list')}}">
                                <i class="fa fa-clock-o text-dark" aria-hidden="true"></i>
                                <span class="text-dark">Batch Time</span></a>
                        </li>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2023 06:37:13 GMT -->
