    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{url('product/update',[$product->id])}}" class="form" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" name="daily_inclome" class="form-control" value="{{$product->daily_inclome}}" placeholder="Daily income">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" name="total_income" class="form-control" value="{{$product->total_income}}" placeholder="Total income">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" name="complite" class="form-control" value="{{$product->complite}}" placeholder="Complete cycle">
